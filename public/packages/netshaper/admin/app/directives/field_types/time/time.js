angular.module('netshaper.admin.fieldType.time', []).directive('nsTime', function($window) {
	return {
		restrict: 'E',
		templateUrl: '/packages/netshaper/admin/app/directives/field_types/time/time.html?v=' + $window.V,
		scope: {
			alias: '@',
			default: '@',
			disabled: '@',
