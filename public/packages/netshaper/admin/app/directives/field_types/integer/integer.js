angular.module('netshaper.admin.fieldType.integer', []).directive('nsInteger', function($window) {
	return {
		restrict: 'E',
		templateUrl: '/packages/netshaper/admin/app/directives/field_types/integer/integer.html?v=' + $window.V,
		scope: {
			alias: '@',
			default: '@',
			disabled: '@',
