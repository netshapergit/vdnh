angular.module('netshaper.admin.fieldType.email', []).directive('nsEmail', function($window) {
	return {
		restrict: 'E',
		templateUrl: '/packages/netshaper/admin/app/directives/field_types/email/email.html?v=' + $window.V,
		scope: {
			alias: '@',
			default: '@',
			disabled: '@',
