...
\t\t\t\t\t\t\t";
            // line 112
            $this->loadTemplate("cityswitcher", "layouts.search_events_twig_vue", 112)->display($context);
            // line 113
            echo "\t\t\t\t\t\t\t<div>
\t\t\t\t\t\t\t<button class=\"icon-btn filter_btn\" @click=\"isCatFiltersShow = !isCatFiltersShow\">
...
\t\t\t\t\t\t";
            // line 180
            $this->loadTemplate("item_vue", "layouts.search_events_twig_vue", 180)->display($context);
            // line 181
...
";
            // line 325
            $this->loadTemplate("footer", "layouts.search_events_twig_vue", 325)->display($context);
            // line 326
            echo "
";
        }
