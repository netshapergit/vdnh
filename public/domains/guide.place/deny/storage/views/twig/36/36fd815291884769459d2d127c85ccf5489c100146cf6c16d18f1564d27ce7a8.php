...
class __TwigTemplate_34e0a52d0911f2c65cf64f47b3d2457596397ceb4e70b6f3eb7e5ea3b6c695b9 extends TwigBridge\Twig\Template
{
...
\t\t\t\t\t\t\t";
            // line 88
            $this->loadTemplate("cityswitcher", "layouts.search_places_twig_vue", 88)->display($context);
            // line 89
            echo "\t\t\t\t\t\t\t<div>
\t\t\t\t\t\t\t<button class=\"icon-btn filter_btn\" @click=\"isCatFiltersShow = !isCatFiltersShow\">
...
";
            // line 351
            $this->loadTemplate("footer", "layouts.search_places_twig_vue", 351)->display($context);
            // line 352
            echo "
";
        }
