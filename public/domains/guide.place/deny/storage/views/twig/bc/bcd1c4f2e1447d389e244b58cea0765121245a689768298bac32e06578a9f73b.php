...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" :value=\"item.value\" name=\"cat-filter-places-service\" @change=\"selectedCatFilters.places.service.items = [item.value]\" :id=\"`cat-filter-places-service-\${i + 1}`\">
