...
\t\t\t\t\t\t\t";
            // line 103
            $this->loadTemplate("cityswitcher", "layouts.search_excursions_twig_vue", 103)->display($context);
            // line 104
            echo "\t\t\t\t\t\t\t<div>
\t\t\t\t\t\t\t<button class=\"icon-btn filter_btn\" @click=\"isCatFiltersShow = !isCatFiltersShow\">
...
\t\t\t\t\t\t";
            // line 171
            $this->loadTemplate("item_vue", "layouts.search_excursions_twig_vue", 171)->display($context);
            // line 172
...
";
            // line 317
            $this->loadTemplate("footer", "layouts.search_excursions_twig_vue", 317)->display($context);
            // line 318
            echo "
";
        }
