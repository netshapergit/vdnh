...
/* layouts.search_hotels_twig */
class __TwigTemplate_dbc917fa7b009203b5ca293291ce94a0ede2b3505390e3334aa910eded815f20 extends TwigBridge\Twig\Template
{
...
";
            // line 41
            $this->loadTemplate("header", "layouts.search_hotels_twig", 41)->display($context);
            // line 42
...
\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" value=\"\" name=\"cat-filter-hotels-type\" @change=\"selectedCatFilters.hotels.type = []\" id=\"cat-filter-hotels-type-0\">
\t\t\t\t\t\t\t\t\t\t<label for=\"cat-filter-hotels-type-0\">Все</label>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"filter-radio\" v-for=\"(item,i) in catFilters.hotels.types\">
\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" :value=\"item.value\" name=\"cat-filter-hotels-type\" @change=\"selectedCatFilters.hotels.type = [item.value]\" :id=\"`cat-filter-hotels-type-\${i + 1}`\">
...
\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" :value=\"item.value\" name=\"cat-filter-hotels-food\" v-model=\"selectedCatFilters.hotels.food\" :id=\"`cat-filter-hotels-food-\${i + 1}`\">
...
\t\t\t\t\t\t\t";
            // line 86
            $this->loadTemplate("cityswitcher", "layouts.search_hotels_twig", 86)->display($context);
            // line 87
            echo "\t\t\t\t\t\t\t<div>
...
\t\t\t\t\t<div class=\"cont\">
\t\t\t\t\t\t<div class=\"search-warning\" v-show=\"emptyAnswer\" v-cloak>Результатов по вашему запросу нет</div>
\t\t\t\t\t\t<div class=\"search-results__wrapper\">
\t\t\t\t\t\t";
            // line 132
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "active_sub_pages", array()));
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 133
                echo "\t\t\t\t\t\t\t<div class=\"search-card\" data-filters=\"";
                ...
                echo "\">
\t\t\t\t\t\t\t\t<div class=\"search-card__gallery splide\" data-gallery=\"";
                // line 134
                ...
                echo "\" style=\"background: url(/site/data/images/medium/";
...
\t\t\t\t\t\t\t\t\t<!--div class=\"search-card__hoverareas\"></div-->
\t\t\t\t\t\t\t\t\t<!--a href=\"";
                // line 136
                ...
                echo "\" class=\"search-card__gallery-item\" style=\"position: absolute; top: 0; left: 0;\">
...
\t\t\t\t\t\t\t\t\t\t<div class=\"search-card__title\"><a href=\"";
                // line 146
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute($context["item"], "path", array()), "html", null, true));
                echo "\">";
                ...
                echo "</a></div>
\t\t\t\t\t\t\t\t\t\t<div class=\"search-card__infoblock search-card__infoblock--address\">
...
\t\t\t\t\t\t\t\t\t\t\t";
                ...
                echo "
\t\t\t\t\t\t\t\t\t\t</div> 
\t\t\t\t\t\t\t\t\t\t<div class=\"search-card__infoblock search-card__infoblock--price\">
\t\t\t\t\t\t\t\t\t\t\t<span class=\"search-card__infoblock-icon\">
...
\t\t\t\t\t\t\t\t\t\t\t ";
                // line 164
                echo $this->env->getExtension('sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute($context["item"], "min_price", array()), "html", null, true));
                echo "₽
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t";
                // line 168
                if ((twig_length_filter($this->env, twig_split_filter($this->env, $this->getAttribute($context["item"], "field_coords", array()), ",")) == 2)) {
                    // line 169
                    echo "\t\t\t\t\t\t\t\t\t\t<div class=\"search-card__action\">
\t\t\t\t\t\t\t\t\t\t\t<button class=\"ibtn\" @click=\"showOnMap('";
                    // line 170
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute($context["item"], "field_coords", array()), "html", null, true));
                    echo "')\">
...
";
            // line 323
            $this->loadTemplate("footer", "layouts.search_hotels_twig", 323)->display($context);
            // line 324
            echo "
";
        }
    ...
    {
        return "layouts.search_hotels_twig";
    }
    ...
    {
        return array (  516 => 324,  514 => 323,  389 => 201,  384 => 199,  362 => 179,  353 => 175,  345 => 170,  342 => 169,  340 => 168,  333 => 164,  322 => 156,  307 => 146,  295 => 137,  291 => 136,  284 => 134,  279 => 133,  275 => 132,  228 => 87,  226 => 86,  216 => 79,  171 => 42,  169 => 41,  166 => 40,  156 => 37,  153 => 36,  151 => 35,  148 => 34,  145 => 33,  139 => 32,  136 => 31,  133 => 30,  130 => 29,  127 => 28,  122 => 27,  120 => 26,  117 => 25,  114 => 24,  112 => 23,  109 => 22,  103 => 19,  100 => 18,  94 => 17,  91 => 16,  85 => 15,  82 => 14,  79 => 13,  76 => 12,  71 => 11,  68 => 10,  64 => 9,  61 => 8,  58 => 7,  55 => 6,  53 => 5,  50 => 4,  48 => 3,  45 => 2,  43 => 1,);
    }
}
...
/* 						<div class="search-warning" v-show="emptyAnswer" v-cloak>Результатов по вашему запросу нет</div>*/
/* 						<div class="search-results__wrapper">*/
/* 						{% for item in page.active_sub_pages %}*/
/* 							<div class="search-card" data-filters="{$ item.field_filters $}">*/
/* 								<div class="search-card__gallery splide" data-gallery="{$ item.field_gallery $}" style="background: url(/site/data/images/medium/{$ item.field_image $}) no-repeat center / cover;">*/
/* 									<!--div class="search-card__hoverareas"></div-->*/
/* 									<!--a href="{$ item.path $}" class="search-card__gallery-item" style="position: absolute; top: 0; left: 0;">*/
...
/* 									</div>*/
/* 									<div class="search-card__actions">*/
/* 										{% if item.field_coords|split(',')|length == 2 %}*/
