...
/* cityswitcher_search_common */
class __TwigTemplate_09e078c8b9d774e21e2cf51eb09753151e9abb0b27b224eded3ffd0cd13bdc8c extends TwigBridge\Twig\Template
{
...
";
        ...
        // line 20
        echo "
<div class=\"city-switcher\" :class=\"{'city-switcher--active': isCitySwitcherShow}\" v-click-outside=\"citySwitchClose\" id=\"citysw-search\"> 
...
\t\t<span v-else>Выберите локацию</span>
\t</div>
\t";
        // line 30
        $context["cats"] = array();
...
\t\t\t";
                // line 38
                $context["cityHeader"] = $this->getAttribute($context["city"], "field_header", array());
                // line 39
                echo "\t\t\t";
                $context["newCat"] = array("city" => (isset($context["cityHeader"]) ? $context["cityHeader"] : null), "cat" => 0, "city_id" => (isset($context["cityID"]) ? $context["cityID"] : null), "city_item" => $context["city"]);
                // line 40
                echo "\t\t\t";
...
\t</transition>
    ...
    {
        return "cityswitcher_search_common";
    }
...
/* 		{% if cat %}*/
/* 			{% set cityID = city.id %}	*/
/* 			{% set cityHeader = city.field_header %}*/
/* 			{% set newCat = {city: cityHeader, cat: 0, city_id: cityID, city_item: city} %}*/
