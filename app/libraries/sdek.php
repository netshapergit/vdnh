...
{
    // auth
    protected static $account = false; //баКаАаЖаИбаЕ аЛаОаГаИаН
    protected static $key     = false; //баКаАаЖаИбаЕ аКаЛбб
    ...
    {
	return array(
	    'YOURCITY'   => 'ааАб аГаОбаОаД',
	    'COURIER'    => 'абббаЕб',
	    'PICKUP'     => 'аЁаАаМаОаВбаВаОаЗ',
	    'TERM'       => 'аЁбаОаК',
	    'PRICE'      => 'аЁбаОаИаМаОббб',
	    'DAY'        => 'аДаН.',
	    'RUB'        => 'ббаБ.',
	    'NODELIV'    => 'ааЕб аДаОббаАаВаКаИ',
	    'CITYSEATCH' => 'ааОаИбаК аГаОбаОаДаА',
	    'CITYSEARCH' => 'ааОаИбаК аГаОбаОаДаА',
	    'ALL'        => 'абаЕ',
	    'PVZ'        => 'абаНаКбб аВбаДаАбаИ',
	    'MOSCOW'     => 'ааОбаКаВаА',
	    'RUSSIA'     => 'а аОббаИб',
	    'COUNTING'   => 'ааДаЕб баАббаЕб',

	    'NO_AVAIL'          => 'ааЕб аДаОбббаПаНбб баПаОбаОаБаОаВ аДаОббаАаВаКаИ',
	    'CHOOSE_TYPE_AVAIL' => 'абаБаЕбаИбаЕ баПаОбаОаБ аДаОббаАаВаКаИ',
	    'CHOOSE_OTHER_CITY' => 'абаБаЕбаИбаЕ аДббаГаОаЙ аНаАбаЕаЛаЕаНаНбаЙ аПбаНаКб',

	    'EST' => 'аЕббб',

	    'L_ADDRESS' => 'ааДбаЕб аПбаНаКбаА аВбаДаАбаИ аЗаАаКаАаЗаОаВ',
	    'L_TIME'    => 'абаЕаМб баАаБаОбб',
	    'L_WAY'     => 'ааАаК аК аНаАаМ аПбаОаЕбаАбб',
	    'L_CHOOSE'  => 'абаБбаАбб',

	    'H_LIST'    => 'аЁаПаИбаОаК аПбаНаКбаОаВ аВбаДаАбаИ аЗаАаКаАаЗаОаВ',
	    'H_PROFILE' => 'аЁаПаОбаОаБ аДаОббаАаВаКаИ',
	    'H_CASH'    => 'а аАббаЕб аКаАббаОаЙ',
	    'H_DRESS'   => 'аЁ аПбаИаМаЕбаКаОаЙ',
	    'H_SUPPORT' => 'аЁаЛбаЖаБаА аПаОаДаДаЕбаЖаКаИ',
	);
    }
